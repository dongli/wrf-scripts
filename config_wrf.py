...
def config_wrf(work_root, wrf_root, wps_root, geog_root, config):
	pprint(config)
...
if __name__ == '__main__':
	...
	parser.add_argument('-m', '--wrf-root', dest='wrf_root', help='WRF root directory (e.g. WRF)')
	...
	config_wrf(args.work_root, args.wrf_root, args.wps_root, args.geog_root, config)
